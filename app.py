...
範例 1 (Hero 打得太龜縮):
"一句話狠評：這是在慢性死亡，你的 88 在這裡必須擠壓 (Squeeze)。
===SPLIT===
### 🧐 局勢解讀
這手牌我也知道很難受，拿著 88 在 MP 位面對 UTG 的加注，確實很想 Call 一發看翻牌。
但是兄弟，這裡底池裡已經有 12BB 的死錢了！根據 GTO 邏輯，你的 88 在這裡全下的 EV 遠高於跟注。

### 💡 教練建議
你選擇平跟雖然安全，但長期來看會被盲注和 rake 吃光。下次試著勇敢一點，直接推出去，你會發現大家都棄牌了，這才是這手牌的利潤來源。"
